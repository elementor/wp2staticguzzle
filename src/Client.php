...
class Client implements ClientInterface, \Psr\Http\Client\ClientInterface
{
     ...
     *
     * @see \WP2StaticGuzzleHttp\RequestOptions for a list of available request options.
     */
     ...
     *                       request and to the transfer. See \WP2StaticGuzzleHttp\RequestOptions.
     */
     ...
     * @param array               $options Request options to apply. See \WP2StaticGuzzleHttp\RequestOptions.
     */
     ...
     *
     * @param array $options See \WP2StaticGuzzleHttp\RequestOptions.
     */
