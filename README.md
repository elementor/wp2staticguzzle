...
| 4.x     | EOL        | `guzzlehttp/guzzle` | `WP2StaticGuzzleHttp` | [v4][guzzle-4-repo] | N/A                 | No    | >= 5.4      |
| 5.x     | EOL        | `guzzlehttp/guzzle` | `WP2StaticGuzzleHttp` | [v5][guzzle-5-repo] | [v5][guzzle-5-docs] | No    | >= 5.4      |
| 6.x     | Security fixes | `guzzlehttp/guzzle` | `WP2StaticGuzzleHttp` | [v6][guzzle-6-repo] | [v6][guzzle-6-docs] | Yes   | >= 5.5      |
| 7.x     | Latest     | `guzzlehttp/guzzle` | `WP2StaticGuzzleHttp` | [v7][guzzle-7-repo] | [v7][guzzle-7-docs] | Yes   | >= 7.2      |
